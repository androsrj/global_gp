...
logPost <- function(trSigma2, trTau2, theta, mu) {
  logLik(exp(trSigma2), exp(trTau2), theta, mu) + # Log Likelihood
...
logRatioSigma2 <- function(propTrSigma2, prevTrSigma2, trTau2, mu) {
