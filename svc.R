...
# Scenario 1
train <- readRDS("data/scen1/train.RDS")
test <- readRDS("data/scen1/test.RDS")
run.svc(1, nReps)


# Scenario 2
train <- readRDS("data/scen2/train.RDS")
test <- readRDS("data/scen2/test.RDS")
run.svc(2, nReps)


# Scenario 3
train <- readRDS("data/scen3/train.RDS")
test <- readRDS("data/scen3/test.RDS")
run.svc(3, nReps)


# Scenario 4
train <- readRDS("data/scen4/train.RDS")
test <- readRDS("data/scen4/test.RDS")
run.svc(4, nReps)


# Scenario 5
train <- readRDS("data/scen5/train.RDS")
test <- readRDS("data/scen5/test.RDS")
run.svc(5, nReps)


# Scenario 6
train <- readRDS("data/scen6/train.RDS")
test <- readRDS("data/scen6/test.RDS")
run.svc(6, nReps)


# Scenario 7
train <- readRDS("data/scen7/train.RDS")
test <- readRDS("data/scen7/test.RDS")
run.svc(7, nReps)


# Scenario 8
train <- readRDS("data/scen8/train.RDS")
test <- readRDS("data/scen8/test.RDS")
run.svc(8, nReps)
